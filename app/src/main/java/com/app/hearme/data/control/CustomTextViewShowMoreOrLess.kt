...
class CustomTextViewShowMoreOrLess @kotlin.jvm.JvmOverloads constructor(
    ...
    private var showMoreTextColor = R.color.green_500
    private var showLessTextColor = R.color.green_500
